...
// Origin allow-list instead of "*" -- this project shares one Supabase
// backend between local dev and prod (see .env.local), so localhost needs
// to stay allowed too, not just the real domain.
